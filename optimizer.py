...
class ColumnRebarOptimizer():
    ...
    def optimize(self, stirrup_d=12, pt_min=20, bn_input=None, hn_input=None):
        result = []
    ...
    def compare(self):
        ...
        #comparision
        self.comparision = pd.DataFrame(self.optimized_rebar/self.origial_rebar,columns=columns)
